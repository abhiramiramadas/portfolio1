...
import { abbyIcon, menu, close } from "../../assets";
  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7x1 mx-auto">
        ...
        >
          <img src={abbyIcon} alt={abbyIcon} className="w-18 h-9 object-contain" />
          <p className="text-white text-[18px] font-bold cursor-pointer flex">
          </p>
        </Link>
        <ul className="list-none hidden sm:flex flex-row gap-10"  style={{ color: '#2867b3ff' }}>
          {navLinks.map((link) => {
            return (
              <li
                key={link.id}
