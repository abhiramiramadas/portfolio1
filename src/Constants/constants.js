...
const introduction = {
  text: [
    [
  "Hey there! I’m really happy you’re here — welcome to my little digital corner! (˶ᵔ ᵕ ᵔ˶)",
  "I'm Abhirami, a 21-year-old IT engineering student, with a love for creative tech, meaningful design, and anything that blends logic with a touch of magic.",
  "I'm especially drawn to building aesthetic and functional web experiences, experimenting with pixel fonts.",
  "When I'm not coding, I enjoy exploring pixel art, making things look pretty on Canva or Figma, and vibing to late-night inspiration.",
  "Thanks a ton for stopping by — this portfolio is a part of me, and I hope it makes you smile too. ♡"
]
